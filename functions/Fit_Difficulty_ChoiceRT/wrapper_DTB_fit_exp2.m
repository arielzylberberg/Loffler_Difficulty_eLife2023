function [err,m,fig_handle] = wrapper_DTB_fit_exp2(theta,coh_pair,choices,RT,model_flag,trcond)
...
[m.choice, m.decision_time, m.coh_model, m.idx_coh_model, m.uni_coh] = ...
    dtb_abs_dv_exp2(kappa, B0, a, d, coh_pair, B0mini, model_flag, trcond);
