function [err,P,pred] = wrapper_dtb_parametricbound_rt(theta,rt,coh,choice,c,pars,plot_flag)
...
pred.RT = (P.lo.p.*P.lo.mean_t+P.up.p.*P.up.mean_t)./(P.lo.p+P.up.p) + ndt_m;

%plot(P.lo.mean_t+ ndt_m); hold on;
%plot(P.up.mean_t+ ndt_m); hold on;
%plot(pred.RT)
%%
